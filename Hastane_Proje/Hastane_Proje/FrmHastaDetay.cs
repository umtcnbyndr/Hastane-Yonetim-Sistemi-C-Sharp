...
namespace Hastane_Proje
{
    public partial class FrmHastaDetay : Form
    {
        ...
        {
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter("Select* From Tbl_Randevular where RandevuBrans='" + comboBox1.Text + "'"+"and RandevuDoktor='"+comboBox1.Text+ "'and RandevuDurum=0" , bgl.baglanti());
            da.Fill(dt);
